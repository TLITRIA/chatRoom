...
// 函数声明
static bool InsertString(MyStr *s, const char *string);
static bool InsertStringByIndex(MyStr *s, int index, const char *string);
static bool RemoveString(MyStr *s, const char *string);
static void ClearString(MyStr *s);
static int StringToInt(MyStr *s);
static double StringToDouble(MyStr *s);
static bool IsStringEqual(MyStr *s1, MyStr *s2);
static MyStr CopyString(MyStr *s);
static MyStrList Split(MyStr *s, const char *string);
static bool ReSize(MyStr *s, long size);
static bool InsertChar(MyStr *s, const char c);

static bool PushBack(MyStrList *list, MyStr s);
static bool RemoveMyString(MyStrList *list, MyStr s);
static void DisplayList(MyStrList *list);
static void ClearMyStrList(MyStrList *list);
...
static void RemoveMyStringByIndex(MyStrList *list, int index)
{
